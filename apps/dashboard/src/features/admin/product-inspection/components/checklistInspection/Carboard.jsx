            ...
            <div className='mt-4'>
                <div className='flex gap-2 mb-2'>
                    <div className='flex-auto w-1/3'>
                        <Chip type="darkgrey">Items</Chip>
                    </div>
                    <div className='flex-1'>
                        <Chip type="darkgrey">Spec</Chip>
                    </div>
                    <div className='flex-1'>
                        <Chip type="darkgrey">Actual</Chip>
                    </div>
                </div>
                <div className='flex gap-2 mb-1'>
                    <div className='flex-auto w-1/3'>
                        <Chip type="white">Cardboard weight</Chip>
                    </div>
                    <div className='flex-1'>
                        <Chip type="grey">1.0</Chip>
                    </div>
                    <div className='flex-1'>
                        <Chip type="white">1.0</Chip>
                    </div>
                </div>
                <div className='flex gap-2 mb-1'>
                    <div className='flex-auto w-1/3'>
                        <Chip type="white">Cardboard thickness</Chip>
                    </div>
                    <div className='flex-1'>
                        <Chip type="grey">1.0</Chip>
                    </div>
                ...
                <div className='flex gap-2 mb-1'>
                    <div className='flex-auto w-1/3'>
                        <Chip type="white">Tape width</Chip>
                    </div>
                    <div className='flex-1'>
                        <Chip type="grey">1.0</Chip>
                    </div>
                ...
                <div className='flex gap-2 mb-1'>
                    <div className='flex-auto w-1/3'>
                        <Chip type="white">Dimension of Carton</Chip>
                    </div>
                    <div className='flex-1'>
                        <Chip type="grey">1.0</Chip>
                    </div>
                ...
                <div className='flex gap-2 mb-1'>
                    <div className='flex-auto w-1/3'>
                        <Chip type="white">Weight of carton</Chip>
                    </div>
                    <div className='flex-1'>
                        <Chip type="grey">1.0</Chip>
                    </div>
