...
import { FREELANCER_ADMIN_KEY } from "~/utils/tokenStorage";
...
export default function AdminLogin() {
   const { freelancerAdminToken, setAuth } = useAuth();
   ...
   const adminLogin = useAdminLogin({
      onSuccess(data) {
         setAuth(FREELANCER_ADMIN_KEY, data.token);
      },
      onError(error) {
         console.log(error);
      },
   ...
   if (freelancerAdminToken) {
      return <Navigate to="/admin/freelancer" replace />;
   }
