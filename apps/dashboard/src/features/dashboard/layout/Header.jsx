...
import { useProfile } from "../hooks/subscriber/useProfile";
                        ...
                        >
                           {
                              isImageError
                                 ? (
                                    <div
                                       className="h-[30px] w-[30px] bg-blue-2/5 rounded-full"
                                    >
                                    </div>
                                 )
                                 : (
                           ...
                           <span className="mx-[12px] font-bold">{data.data?.username}</span>
                           <div
      ...
      >
         ...
         <div
            className={classNames(
               line,
               "transition",
               [isActive ? '-rotate-[45deg] top-1/2 transform -translate-y-1/2' : 'bottom-[3px]']
            )}
         ></div>
      </button>
   )
