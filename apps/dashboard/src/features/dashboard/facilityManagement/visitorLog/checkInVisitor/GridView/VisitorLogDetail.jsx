   ...
   return (
      <>
            ...
            <div className="px-[24px] pb-4">
               {/* <div className="py-4 border-solid border-x-0  border-t-0 border-b border-[#e9e9e9]">
                  <div className="flex gap-3">
                     <Button onClick={() => setIsOpenCheckoutDialog(true)} label="Checkout" />
                  </div>
               </div> */}
               <div className="py-4 border-solid border-x-0 border-t-0 border-b border-[#e9e9e9]">
                  <h1 className="mb-[12px] text-[16px]">In Notes</h1>
               ...
               <div className="py-4 flex gap-12  border-solid border-x-0 border-t-0 border-b border-[#e9e9e9]">
                  <div>
                     <h1 className="text-[16px] mb-[12px]">In Date</h1>
                     <span className="flex items-center gap-2">
                        <IconTime />
                        {formatDate(state.date_in)}
                     </span>
                  </div>
                  <div>
               ...
               <div className="py-4 flex flex-column  border-solid border-x-0 border-t-0 border-b border-[#e9e9e9]">
                  <h1 className="text-[16px] mb-[12px]">Signed In By</h1>
         ...
         <CheckoutDialog
            ...
            onClose={() => setIsOpenCheckoutDialog(false)}
         />
      </>
   )
}