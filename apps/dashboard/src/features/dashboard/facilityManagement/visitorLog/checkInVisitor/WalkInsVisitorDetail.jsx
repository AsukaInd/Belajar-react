...
export function WalkInsVisitorDetail(props) {
               ...
               <div className="grid grid-cols-2 border-solid border-x-0 border-t-0 border-bottom-1 border-[#f4f4f4]">
                  <div className="col p-0">
                     ...
                     <div className="visitor-item">
                        ...
                        <span className="visitor-value">
                           {formatDate(visitorData.date_in)}
                        </span>
                     </div>
                     <div className="visitor-item">
                  ...
                  <div className="col p-0">
                     ...
                     {/* <div className="visitor-item">
                        ...
                        <span className="visitor-value">{visitorData.host}</span>
                     </div>
                     <div className="visitor-item">
                        <span className="visitor-title">Host Company</span>
                        <span className="visitor-value">
                           {visitorData.host_company}
                        </span>
                     </div> */}
                     <div className="visitor-item">
