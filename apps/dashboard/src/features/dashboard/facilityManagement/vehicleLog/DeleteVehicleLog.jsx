...
export function DeleteVehicleLog({ isOpen, onClose }) {
   ...
   return (
      ...
      >
         ...
         >
            <IconDelete solid />
            <h1 className="mb-2 mt-5 text-xl">Delete this vehicle</h1>
            <p className="mb-4 text-center">
               Are you sure want to delete this vehicle? This action can not be
               undone
            </p>
