...
export function DeleteUser({ userId, isOpen, onClose, clientId, bulkDelete, ids }) {
      ...
      <>
         ...
         >
            ...
            >
               ...
               {bulkDelete ? (
                  <>
                     <h1 className="mb-2 mt-5 text-xl">Delete selected host</h1>
                     <p className="mb-4 text-center">
                        Are you sure want to delete all of selected host? This
