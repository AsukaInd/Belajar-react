...
import { useDeleteAsset } from '~/features/dashboard/facilityManagement/hooks/asset/useDeleteAsset'
import { Toast } from "primereact/toast";
import { useRef } from 'react'

export function DeleteAsset({ id, isOpen, onClose, bulkDelete, ids }) {
      ...
      <>
         ...
         >
            ...
            >
               ...
               {bulkDelete ? (
                  <>
                     <h1 className="mb-2 mt-5 text-xl">Delete selected asset</h1>
                     <p className="mb-4 text-center">
                        Are you sure want to delete all of selected asset? This
                        action can not be undone
                     </p>
                  </>
               ) : (
                  <>
                     <h1 className="mb-2 mt-5 text-xl">Delete this asset</h1>
                     <p className="mb-4 text-center">
                        Are you sure want to delete this asset? This action can not
                        be undone
                     </p>
                  </>
               )}
