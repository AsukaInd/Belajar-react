...
import { useDeleteVendor } from '~/features/dashboard/facilityManagement/hooks/vendor/useDeleteVendor'
import { Toast } from "primereact/toast";
import { useRef } from 'react'

export function DeleteVendor({ id, isOpen, onClose, bulkDelete, ids }) {
      ...
      <>
         ...
         >
            ...
            >
               ...
               {bulkDelete ? (
                  <>
                     <h1 className="mb-2 mt-5 text-xl">Delete selected vendor</h1>
                     <p className="mb-4 text-center">
                        Are you sure want to delete all of selected vendor? This
                        action can not be undone
                     </p>
                  </>
               ) : (
                  <>
                     <h1 className="mb-2 mt-5 text-xl">Delete this vendor</h1>
                     <p className="mb-4 text-center">
                        Are you sure want to delete this vendor? This action can
                        not be undone
                     </p>
                  </>
               )}
