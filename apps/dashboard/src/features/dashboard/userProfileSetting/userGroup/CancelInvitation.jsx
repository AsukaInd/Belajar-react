...
export function CancelInvitation({ id, isOpen, onClose }) {
   ...
   return (
      <>
         ...
         >
            ...
            >
               <IconDelete solid />
               <h1 className="mb-2 mt-5 text-xl">Cancel this invitation</h1>
               <p className="mb-4 text-center">
                  Are you sure want to cancel this invitation? This action can
                  not be undone
               </p>
