         ...
         <table className="mt-4 overflow-auto w-[768px] md:w-full">
            <thead>
               <tr className="text-white rounded-lg">
                  <th className="bg-grey-a7 py-2 md:w-[400px] rounded-l-md ">Style/Weight</th>
